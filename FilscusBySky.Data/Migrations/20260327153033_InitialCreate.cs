        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVisueleBeperking = table.Column<bool>(type: "bit", nullable: false),
                    AangemeldOp = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rekeningen_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transacties_Rekeningen_RekeningId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rekeningen_UserId",
                table: "Rekeningen",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Transacties_RekeningId",
                table: "Transacties",
                column: "RekeningId");
        }
