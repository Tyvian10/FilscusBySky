...
namespace FilscusBySky.Data.Migrations
{
    ...
    [Migration("20260411190823_AddDomiciliaties")]
    partial class AddDomiciliaties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilscusBySky.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("AangemeldOp")
                    ...
                    b.Property<bool>("IsVisueleBeperking")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FilscusBySky.Models.Transactie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FilscusBySky.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
